...
export default function Header() {
  return (
    <nav className="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true" style={{background: '#866ec7'}}>
      <div className="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 className="font-weight-bolder mb-0" style={{color: 'white'}}>Wedding</h6>
        </nav>
        <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4"  id="navbar">
          ...
          <ul className="navbar-nav justify-content-end">
            ...
            <li className="nav-item d-flex align-items-center">
              <a href="#" className="nav-link text-body font-weight-bold px-0" style={{color: 'white'}}>
                <i className="fa fa-user me-sm-1" style={{color: 'white'}}/>
                <span className="d-sm-inline d-none" style={{color: 'white'}}>ADMIN</span>
              </a>
            </li>
          </ul>
        </div>
